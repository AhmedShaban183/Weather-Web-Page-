...
export const updateWeather = function (lat, lon) {
    ...
    const highlightSection = document.querySelector("[data-highlights]");
     const hourlySection = document.querySelector("[data-hourly-forcast]");
...
fetchData(url.currentWeather(lat,lon),function(currentWeather){
    ...
    const { weather , dt: dateUnix,sys: {sunrise: sunriseUnixUTC, sunset: sunsetUnixUTC },
    ...
    card.innerHTML=`
            <h2 class="title-2 card-title">Now</h2>
                    <div class="wrapper">
                        ...
                        <img src="./assets/images/weather_icons/${icon}.png" width="64" height="64" alt="${description}" class="weather_icons">
                    </div>
    ...
    fetchData(url.airPollution (lat, lon), function (airPollution) {
                ...
                const card = document.createElement("div"); card.classList.add("card", "card-lg");
                card.innerHTML = `
                ...
                <div class="highlight-list">
                    ...
                    <div class="card card-sm highlight-card">
                        ...
                        <div class="wrapper">
                            <span class="m-icon">humidity-percentage</span>
                    ...
                    <div class="card card-sm highlight-card">
                        <h3 class="title-3">visibilty</h3>
                        <div class="wrapper">
                            <span class="m-icon">visibilty</span>
                            <p class="title-1">${(visibility/1000)}<sub>Kkm</sub></p>
                        </div>
                    </div>
...
fetchData(url.forecast(lat, lon), function (forecast) {
    ...
    forecastSection.innerHTML =`
      <h2 class="title-2" id="forecst-label">5 Days Forecast</h2>
    ...
    for (let i = 7, len = forecastList.length; i < len; i += 8) {
        ...
        li.innerHTML=`
                            <div class="icon-wrapper">
                                <img src="./assets/images/weather_icons/${icon}.png" width="36" height="36" alt="${description}"
                                 class="weather_icon" title="${description}">
                                <span class="span">
        ...
        `;
        forecastSection.querySelector("ul").appendChild(li)
